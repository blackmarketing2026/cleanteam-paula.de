...
async function api(action, body) {
  switch (action) {
    case "offer":
      return FakeAPI.publicGetOffer(token);
    case "start":
      return FakeAPI.publicStart(token);
    case "confirm-data":
      return FakeAPI.publicConfirmData(token, body.confirmed);
    case "confirm-interval":
      return FakeAPI.publicConfirmInterval(token, body.confirmed);
    case "authorization":
      return FakeAPI.publicAuthorization(token, body.authorized, body.representationNote);
    case "advance":
      return FakeAPI.publicAdvance(token, body.step);
    case "sign":
      return FakeAPI.publicSign(token, body.signatureDataUrl);
    default:
