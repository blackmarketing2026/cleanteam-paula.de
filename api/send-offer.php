...
$pdo->prepare($sendAsQuote ? "UPDATE offers SET sent_at = UTC_TIMESTAMP(), quote_status = 'sent' WHERE id = :id" : 'UPDATE offers SET sent_at = UTC_TIMESTAMP() WHERE id = :id')->execute(['id' => $offerId]);
